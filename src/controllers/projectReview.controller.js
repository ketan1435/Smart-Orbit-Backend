...
export const submitProjectReview = catchAsync(async (req, res) => {
    ...
    if (projectWaterfall.currentStepNumber < 5) {
        throw new ApiError(httpStatus.BAD_REQUEST, `Project is not ready for admin review. Current step: ${projectWaterfall.currentStepNumber}. Must be at step 5 or later.`);
    }
